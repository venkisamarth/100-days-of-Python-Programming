# -*- coding: utf-8 -*-
"""day 56 introduction to the oops in python.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1GTszRjDOUBEoDMtZPPOXLs_7z4nosLmQ

Introducntion to Object-oriented programming
...
class Tree:
    def __init__(self, species, height):
        ...
        self.height = height
        print(f"A {self.species} tree is planted. Height: {self.height} meters.")

    def grow(self, growth):
        self.height += growth
        print(f"The {self.species} tree grows. New height: {self.height} meters.")

    def __del__(self):
        print(f"The {self.species} tree is cut down.")
...
# The destructor is automatically called when the object is deleted (e.g., when the program ends)
